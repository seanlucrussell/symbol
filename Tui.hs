...
-- 
-- appEvent (State renderer NotReading z@(ZipperAs _ _)) (VtyEvent (EvKey (KChar 'p') [])) = continue (State renderer (SelectingStatement (L.list () (Vec.fromList (possibleStatements z)) 1)) z)

...
--         where validateProgram' c (AssignmentTerm (IdentifierTerm a) t' b:ts) = case typeOf c b of
...
--                                Nothing -> False
--                 Nothing -> False
--               validateProgram' c (AssignmentTerm UnknownTerm t' b:ts) = case typeOf c b of
--                 Just t -> case termToType t' of
...
-- termToType (FunctionTypeTerm a b) = do a' <- termToType a
--                                        b' <- termToType b
